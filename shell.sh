...
#工程名 将XXX替换成自己的工程名
project_name=RobooProject

#scheme名 将XXX替换成自己的sheme名
scheme_name=RobooProject

#打包模式 Debug/Release
development_mode=Debug

#build文件夹路径
build_pathtest=${project_path}
build_path=${project_path}/RobooProject/build
echo "$build_pathtest"
#plist文件所在路径
    ...
    read platform
        ...
        do
            ...
            if [ $platform == 1 ];
                ...
                #上传到蒲公英
                #蒲公英aipKey
                MY_PGY_API_K=264f52b6dc54ec06326ce248a7b6df54
                #蒲公英uKey
                MY_PGY_UK=1c0e9a115168debfe02fae27fbdcf44f
