...
@interface RBIntroductoryPagesView ()<UIScrollViewDelegate>
...
@implementation RBIntroductoryPagesView

+ (instancetype)pagesViewWithFrame:(CGRect)frame images:(NSArray<NSString *> *)images
{
    RBIntroductoryPagesView *pagesView = [[self alloc] initWithFrame:frame];
