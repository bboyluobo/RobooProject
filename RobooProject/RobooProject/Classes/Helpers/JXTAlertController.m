...
@implementation UIAlertController (RB)
 ...
 */
+ (void)rb_showAlertWithTitle:(nullable NSString *)title
...
+ (void)rb_showDelayAlertWithTitle:(NSString *)title message:(NSString *)message appearanceProcess:(JXTAlertAppearanceProcess)appearanceProcess actionsBlock:(JXTAlertActionBlock)actionBlock NS_AVAILABLE_IOS(8_0)
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[UIWindow zf_currentViewController] jxt_showAlertWithPreferredStyle:UIAlertControllerStyleAlert title:title message:message appearanceProcess:appearanceProcess actionsBlock:actionBlock];
    });
}
 ...
 */
+ (void)rb_showActionSheetWithTitle:(nullable NSString *)title
                            message:(nullable NSString *)message
                  appearanceProcess:(JXTAlertAppearanceProcess)appearanceProcess
                       actionsBlock:(nullable JXTAlertActionBlock)actionBlock NS_AVAILABLE_IOS(8_0)
{
